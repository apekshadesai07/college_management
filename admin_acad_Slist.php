...
<tr><th>#</th><th>Student ID</th><th>First Name</th><th>Last Name</th><th>Father Name</th><th>Mother Name</th><th>DOB</th><th>Gender</th><th>Category</th><th>Contact no</th><th>Branch</th><th>Ranking</th><th>Roll No</th><th>Address</th><th>Batch</th></tr>
</thead>
...
<!-- SQL query goes here -->
<?php 
$strSQL = "SELECT sid, firstname, lastname,father_name,mother_name,dob,gender,category,s_mob_no,branch,jee_rank,jee_roll_no,address,batch FROM student";
 ...
 while($row = mysql_fetch_array($rs)) {
  ...
  <tr id="w1-filters" class="filters">
    ...
    <td><?php  echo $jeerank   ?></td>
    <td><?php  echo $jeerollno   ?></td>
