...
-->
<form method="post" action="TranspotationTimeTable.php">
<div class="text-center" class="img-left">
    <img src="image/iiit_img.png" alien="right" hight="80" width="80">
   <font size="6"><b >M S Ramaiah Institute Of Technology, Bengaluru </font>
    <br>MSRIT Post, M S Ramaiah Nagar,  
    <br>Bengaluru, Karnataka 560054, India - Contact No. +91-80-23606939</b>
...
<tr>
    ...
    <th name="Sl1B"><?php  echo $objPHPExcel->getActiveSheet()->getCell('B5')->getValue(); ?></th>
     <th name="Sl1F"> <?php  echo $objPHPExcel->getActiveSheet()->getCell('C5')->getValue(); ?></td></th> 
